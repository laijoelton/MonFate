...
// Seed data for the citizen UI, which renders before any live
// backend response arrives. Restored for cyberjaya-map; the cockpit
// itself reads live data and does not use these.
...
/** Fixed clock, so relative timestamps stay stable against the seeds above. */
